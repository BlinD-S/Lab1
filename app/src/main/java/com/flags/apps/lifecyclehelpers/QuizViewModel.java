package com.flags.apps.lifecyclehelpers;
...
public class QuizViewModel extends ViewModel {
    ...
    public int getFlagsInQuiz() {
        return flagsInQuiz;
    }

    public void setFlagsInQuiz(String flagsInQuiz) {
        this.flagsInQuiz = Integer.parseInt(flagsInQuiz);
    }
