...
import com.flags.apps.eventhandlers.GuessButtonListener;
...
public class MainActivityFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        this.questionNumberTextView.setText(
                getString(R.string.question, 1, this.getQuizViewModel().getFlagsInQuiz()));
        return view;
    }
    ...
    public void resetQuiz() {
        ...
        while (flagCounter <= this.getQuizViewModel().getFlagsInQuiz()) {
    ...
    private void loadNextFlag() {
        ...
        questionNumberTextView.setText(getString(R.string.question,
                (quizViewModel.getCorrectAnswers() + 1), this.getQuizViewModel().getFlagsInQuiz()));
