package com.flags.apps.mainapp;
...
import com.flags.apps.eventhandlers.PreferenceChangeListener;
...
public class MainActivity extends AppCompatActivity {
    ...
    public static final String QUIZ_ITEMS = "pref_numberOfQuizItems";
    ...
    protected void onStart() {
        ...
        if (preferencesChanged) {
            ...
            this.quizViewModel.setFlagsInQuiz(PreferenceManager.getDefaultSharedPreferences(this)
                    .getString(QUIZ_ITEMS, null));
    ...
    public static String getQUIZ_ITEMS() {
        return QUIZ_ITEMS;
    }
