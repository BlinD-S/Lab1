package com.flags.apps.eventhandlers;

import android.content.SharedPreferences;
import android.content.SharedPreferences.OnSharedPreferenceChangeListener;
import android.widget.Toast;

import com.flags.apps.mainapp.MainActivity;
import com.flags.apps.mainapp.MainActivityFragment;
import com.flags.apps.lifecyclehelpers.QuizViewModel;

import java.util.Set;

import com.flags.apps.mainapp.R;
...
public class PreferenceChangeListener implements OnSharedPreferenceChangeListener {
    ...
    public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String key) {
        ...
        if (key.equals(this.mainActivity.getQUIZ_ITEMS())){
            this.mainActivity.getQuizViewModel().setFlagsInQuiz(sharedPreferences.getString(
                    MainActivity.QUIZ_ITEMS, null));
            this.mainActivity.getQuizFragment().resetQuiz();
        }
        else if (key.equals(this.mainActivity.getREGIONS())) {
